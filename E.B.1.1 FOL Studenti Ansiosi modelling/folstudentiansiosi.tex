...
\begin{itemize}
  \item Dominio = $\{\mathrm{Giovanni}, \mathrm{Sicurezza}\}$
\end{itemize}

\paragraph{Interpretazione}
\begin{itemize}
  \item $\mathrm{Studente}^M = \varnothing$
  \item $\mathrm{Esame}^M = \{\mathrm{Sicurezza}\}$
  \item $\mathrm{Ansioso}^M = \{\mathrm{Giovanni}\}$
...
\paragraph{Interpretazione}
\begin{itemize}
  \item $\mathrm{Studente}^I = \{\mathrm{Giovanni}\}$
  \item $\mathrm{Esame}^I = \{\mathrm{Sicurezza}\}$
  \item $\mathrm{Ansioso}^I = \{\mathrm{Giovanni}\}$
  \item $\mathrm{StudiaProgramma}^I = \varnothing$
  \item $\mathrm{Supera}^I = \{(\mathrm{Giovanni}, \mathrm{Sicurezza})\}$
\end{itemize}

\paragraph{Verifica che $I \not\models \phi$}

Per $x=\mathrm{Giovanni}$ e $y=\mathrm{Sicurezza}$ si ha:
\[
\left(
  \mathrm{Studente}(\mathrm{Giovanni})
  \land
  \mathrm{Esame}(\mathrm{Sicurezza})
  \land
  \left(
    \mathrm{Ansioso}(\mathrm{Giovanni})
    \lor
    \neg \mathrm{StudiaProgramma}(\mathrm{Giovanni},\mathrm{Sicurezza})
  \right)
\right)
\Rightarrow
\neg \mathrm{Supera}(\mathrm{Giovanni},\mathrm{Sicurezza})
\]
L'antecedente dell'implicazione è vero, ma il conseguente
\[
\neg \mathrm{Supera}(\mathrm{Giovanni},\mathrm{Sicurezza})
\]
è falso poiché $(\mathrm{Giovanni}, \mathrm{Sicurezza}) \in \mathrm{Supera}^I$. Pertanto l'implicazione è falsa.
